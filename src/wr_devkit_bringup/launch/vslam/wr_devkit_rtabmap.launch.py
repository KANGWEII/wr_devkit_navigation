...
def generate_launch_description():
    ...
    remappings=[
        ('odom','/odom'),
        ('scan','/scan'),
        ('rgb/image', '/front_cam/front_d435i/color/image_raw'),
        ('rgb/camera_info', '/front_cam/front_d435i/color/camera_info'),
        ('depth/image', '/front_cam/front_d435i/depth/image_rect_raw')
    ]
